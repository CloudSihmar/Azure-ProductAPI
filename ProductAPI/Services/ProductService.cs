...
namespace ProductAPI.Services
{
    public class ProductService
    {
        private SqlConnection GetConnection()
        {
            ...
            string connectionString = "Server=tcp:product-data.database.windows.net,1433;Initial Catalog=product-data;Persist Security Info=False;User ID=admindb;Password=Tech@2020;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
